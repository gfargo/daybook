...
const SOURCE_HELP = 'source type: coinbase, kraken, crypto-com, csv, binance, binance-us, bybit, gemini, mexc, okx, robinhood, eth, polygon, arbitrum, base, optimism, bnb';
...
program
  ...
  .requiredOption('--source <id>', SOURCE_HELP)
  .option('--file <path>', 'CSV file path (required for kraken, crypto-com, csv, binance, binance-us, bybit, gemini, mexc, okx, robinhood; optional for coinbase CSV import)')
